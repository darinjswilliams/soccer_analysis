...
class CameraMovementEstimator:
    def __init__(self, frame):
        ...
        first_frame_gracy_scale = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
    ...
    def get_camera_movement(self, frames, read_from_stub=False, stub_path=None):
        ...
        camera_movement = [[0,0]] * len(frames)  # No movement for simplicity
        ...
        for frame in range(1, len(frames)):
            ...
            new_features, _, _ = cv2.calcOpticalFlowPyrLK(old_gray, frame_gray, old_features, None, **self.ik_params)

            # Measure the maximum displacement of the features
            max_distance = 0
